...
\hline
	Problema: & \specialcell{Brindar informaci\'on acerca\\del Depto. trabajo social y salud\\a los estudiantes del Tecnol\'ogico.}\\
\hline
...
\hline
	\specialcell{Depto.\\Trabajo Social\\y\\Salud} & \specialcell{Divulgaci\'on de informaci\'on\\a la comunidad estudiantil\\con dispositivos Android.} & \specialcell{Divulgar Informaci\'on a la\\comunidad estudiantil.} & \specialcell{Debe correr en \\Android.}\\
\hline
	\specialcell{Comunidad\\Estudiantil} & \specialcell{Facilitar comunicaci\'on entre\\el interesado y el departamento\\de salud.} & \specialcell{Obtener informaci\'on de\\f\'acil acceso.} & \specialcell{Debe ser\\de\\f\'acil acceso.} \\
\hline
\end{tabular}
\end{small}
