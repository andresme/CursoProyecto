...
\title{\begin{flushright}\textbf{Visi\'on y Alcance} \\[0.7in] 
		Proyecto: \\[0.2in]
		\textbf{Aplicaci\'on M\'ovil para la Clinica de Salud del Tecnol\'ogico de Costa Rica}\\[0.7in]
		Versi\'on 1.1 \\[0.7in]
		Preparado por: \\[0.2in]
...
Este proyecto pretende dar soluci\'on a un problema del departamento de salud, el cual es brindar informaci\'on b\'asica a la comunidad institucional sobre el mismo.
...
\hline
	Problema: & \specialcell{Brindar informaci\'on acerca\\del Depto. trabajo social y salud\\a la comunidad del Tecnol\'ogico.}\\
\hline
	Afectados: & Estudiantes, funcionarios y departamento de salud.\\
\hline
	Impacto: & \specialcell{Divulgar informaci\'on del departamento de salud\\ mediante el uso de tecnol\'ogia.}\\
\hline
	Soluci\'on & Divulgar informaci\'on a los estudiantes y funcionarios del tecnol\'ogico.\\
\hline
...
\begin{itemize}
	...
	\item{Recordar a los usuarios sobre sus citas.}
...
Desarrollar la aplicaci\'on para el sistema operativo Android con una interfaz de usuario amigable, para que los estudiantes y funcionarios se sientan comodos al usarla y que esta aplicaci\'on sea usada por la comunidad institucional para obtener informaci\'on sobre este departamento.
...
El alcance de la versi\'on inicial incluye la informaci\'on basica del Depto. de Trabajo Social y Salud:
\begin{itemize}
	\item{Horarios.}
	\item{Ubicaci\'on.}
...
\end{itemize}
\begin{footnotesize} Nota Importante: Este versi\'on del sistema no registrar\'a citas en el sistema del Depto. de Trabajo Social y Salud, y el \'unico capaz de ver y modificar esta informaci\'on es el usuario de la aplicaci\'on. \end{footnotesize}
...
\hline
	\specialcell{Depto.\\Trabajo Social\\y\\Salud} & \specialcell{Divulgaci\'on de informaci\'on\\a la comunidad institucional\\con dispositivos Android.} & \specialcell{Divulgar Informaci\'on a la\\comunidad del Instituto Tecnol\'ogico de Costa Rica.} & \specialcell{Debe correr en \\Android.}\\
\hline
	\specialcell{Comunidad\\Insititucional} & \specialcell{Facilitar comunicaci\'on entre\\el interesado y el departamento\\de salud.} & \specialcell{Obtener informaci\'on de\\f\'acil acceso.} & \specialcell{Debe ser\\de\\f\'acil acceso.} \\
\hline
\end{tabular}
\end{small}
