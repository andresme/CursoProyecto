...
\hline
	Problema: & \specialcell{Brindar informaci\'on acerca\\del Depto. Trabajo Social y Sal\'ud\\a la comunidad del Tecnol\'ogico.}\\
\hline
	Afectados: & Estudiantes, funcionarios y departamento de Sal\'ud.\\
\hline
	Impacto: & \specialcell{Divulgar informaci\'on del departamento de Sal\'ud\\ mediante el uso de tecnol\'ogia.}\\
\hline
...
\hline
	\specialcell{Depto.\\Trabajo Social\\y\\Sal\'ud} & \specialcell{Divulgaci\'on de informaci\'on\\a la comunidad institucional\\con dispositivos Android.} & \specialcell{Divulgar Informaci\'on a la\\comunidad del\\Instituto Tecnol\'ogico\\de\\Costa Rica.} & \specialcell{Debe correr en \\Android.}\\
\hline
	\specialcell{Comunidad\\Insititucional} & \specialcell{Facilitar comunicaci\'on entre\\el interesado y el departamento\\de Sal\'ud.} & \specialcell{Obtener informaci\'on de\\f\'acil acceso.} & \specialcell{Debe ser\\de\\f\'acil acceso.} \\
\hline
\end{tabular}
\end{small}
